...
public class StoreResponse {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(description = "업소 통계 정보")
    public static class StoreStats {
        
        @Schema(description = "업종별 통계")
        private List<BusinessTypeStats> businessTypeStats;
        
        @Schema(description = "지역별 통계")
        private List<RegionStats> regionStats;
        
        @Schema(description = "전체 업소 수", example = "1000")
    ...
    public static class BusinessTypeStats {
        ...
        @Schema(description = "업소 수", example = "500")
        private long count;
    }
